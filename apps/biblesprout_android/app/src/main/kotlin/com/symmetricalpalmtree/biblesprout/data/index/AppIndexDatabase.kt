 ...
 */
@Database(
    entities = [AppSetting::class, Source::class, ReadingProgress::class, Bookmark::class],
    version = 2,
    exportSchema = false,
)
abstract class AppIndexDatabase : RoomDatabase() {
    ...
    companion object {
        // v2 adds the bookmark table; the migration preserves the reading position
        // and settings rather than wiping the index. The CREATE statements must
        // match what Room generates for the Bookmark entity exactly.
