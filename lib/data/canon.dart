...
class Canon {
  ...
  static const List<CanonBook> books = [
    ...
    CanonBook(usfm: 'JOS', ordinal: 6, name: 'Joshua', testament: Testament.old, aliases: ['jsh', 'josh']),
    CanonBook(usfm: 'JDG', ordinal: 7, name: 'Judges', testament: Testament.old, aliases: ['jdgs', 'judg']),
